...
export const metadata: Metadata = {
  title: "Terms & Conditions | Service & Installation Agreements | Optima",
  description:
    "Review Optima Safety Solutions terms and conditions for safety netting and invisible grill installations, service warranties, and payment policies in Chennai.",
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-xs flex flex-col gap-6">
          ...
          <div className="space-y-6 text-xs sm:text-sm text-slate-500 leading-relaxed">
            ...
            <p>
              Any disputes or legal inquiries relating to installations, material sales, or contracts executed by Optima Safety Solutions are governed under the exclusive jurisdiction of the courts of Chennai, Tamil Nadu, India.
            </p>
          </div>
        </div>
      </div>
