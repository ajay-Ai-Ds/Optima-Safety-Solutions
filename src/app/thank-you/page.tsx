...
export const metadata: Metadata = {
  title: "Thank You | Request Booking Confirmed | Optima Safety Solutions",
  description:
    "Your request for a free site measurement and quote has been successfully received by Optima Safety Solutions. We will contact you shortly.",
  robots: {
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 text-center select-none">
      <div className="max-w-md bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-md flex flex-col items-center gap-6">
        ...
        <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
          Thank you for contacting Optima Safety Solutions. Our local Chennai team will review your service requirements and contact you within 24 hours to schedule your free site inspection.
        </p>
