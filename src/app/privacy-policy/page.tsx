...
export const metadata: Metadata = {
  title: "Privacy Policy | Optima Safety Solutions Chennai",
  description:
    "Review the privacy policy for Optima Safety Solutions, outlining our data handling practices, security protocols, and cookies policy for site inquiries.",
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-xs flex flex-col gap-6">
          ...
          <div className="space-y-6 text-xs sm:text-sm text-slate-500 leading-relaxed">
            ...
            <p>
              If you have any questions regarding this Privacy Policy or wish to request the deletion of your submission logs, please contact us at optimasafetysolutions77@gmail.com or call +91 78937 60933.
            </p>
          </div>
        </div>
      </div>
