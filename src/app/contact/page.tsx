...
export const metadata: Metadata = {
  title: "Contact Us | Free Site Measurement & Quote Chennai | Optima",
  description:
    "Get in touch with Optima Safety Solutions for professional safety netting and invisible grill setup. Call +91 78937 60933 or request a free quote online.",
  alternates: {
    canonical: "/contact",
  },
};
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <a href="tel:+917893760933" className="text-sm font-bold text-slate-700 hover:text-accent-orange transition-colors">
                    +91 78937 60933
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <a href="mailto:optimasafetysolutions77@gmail.com" className="text-sm font-bold text-slate-700 hover:text-accent-orange transition-colors">
