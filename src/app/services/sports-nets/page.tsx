...
export const metadata = {
  title: "Sports Nets Installation in Chennai | High-Impact Boundary Netting",
  description:
    "Secure your sports courts, rooftop pitches, and school grounds with premium high-impact sports boundary netting. Free measurements across Chennai.",
  alternates: {
    canonical: "/services/sports-nets",
  },
};

export default function SportsNetsCategoryPage() {
  const categoryServices = Object.values(servicesData).filter((s) => s.category === "sports-nets");
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "Sports Nets",
        "item": "https://www.optimasafetysolutions.in/services/sports-nets",
      },
    ],
  };
    ...
    <div className="bg-slate-50 min-h-screen py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-8" aria-label="Breadcrumb">
          ...
          <span>/</span>
          <span className="text-slate-600 font-bold">Sports Nets</span>
        </nav>
        ...
        <div className="text-left max-w-3xl mb-16 flex flex-col gap-3">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-800 tracking-tight leading-tight">
            Sports Nets (1 Service)
          </h1>
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Protect surrounding properties and secure your play areas with our heavy-duty sports netting. Woven from UV-stabilized braided nylon twine, our nets absorb high ball strikes cleanly while enduring outdoor sun.
          </p>
        </div>
        ...
        <div className="mt-20 pt-10 border-t border-slate-200">
          <h2 className="text-xl font-bold text-slate-800 mb-6">
            Sports Nets Installation Services by Chennai Localities
          </h2>
          <p className="text-slate-500 text-xs sm:text-sm mb-6 max-w-2xl">
            We provide fast, professional sports nets installation across key areas in Chennai. Explore localized details for your neighborhood:
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs font-semibold">
            {[
              ...
              <Link
                key={loc.slug}
                href={`/services/sports-nets/${loc.slug}`}
              ...
              >
                <span>Sports Nets in {loc.name}</span>
