...
export const metadata: Metadata = {
  title: "Search Services, Areas & Blogs | Optima Safety Solutions",
  description:
    "Search across Optima Safety Solutions balcony safety nets, invisible steel wire grills, laundry hangers, case study projects, and coverage areas in Chennai.",
  alternates: {
    canonical: "/search",
  },
};
