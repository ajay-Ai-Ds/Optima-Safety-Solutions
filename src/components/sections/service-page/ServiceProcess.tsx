...
// Why Choose Optima Cards (6 cards)
export function ServiceWhyChoose() {
  ...
  return (
    <section className="bg-slate-50 py-20 scroll-mt-12" id="why-choose-optima">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16 flex flex-col gap-3">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-800">
            Why Choose Optima Safety Solutions
          </h2>
        </div>
...
export function ServiceRelated({ related, categoryName, categorySlug }: RelatedProps) {
  const currentCategorySlug = categorySlug || "safety-nets";
              ...
              <div className="flex flex-wrap gap-2">
                {localitiesList.map((slug) => {
                  ...
                  return (
                    <Link
                      key={slug}
                      href={`/services/${currentCategorySlug}/${slug}`}
                      className="text-xs font-semibold px-3 py-1.5 bg-slate-50 hover:bg-orange-50 border border-slate-200 hover:border-accent-orange/30 rounded-lg text-slate-600 hover:text-accent-orange transition-all"
                    >
                      {areaName}
                    </Link>
                  );
