      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xs text-slate-500 leading-relaxed max-w-md">
            This section is reserved for real reviews from Optima Safety Solutions customer database. Ratings and testimonials will be populated as soon as verified client logs are shared.
          </p>
        </motion.div>
      </div>
    </section>
