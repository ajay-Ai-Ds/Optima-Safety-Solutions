        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            <div className="relative h-72 sm:h-96 w-full">
              <Image
                src="/images/hero/before-balcony.png"
          ...
          >
            <div className="relative h-72 sm:h-96 w-full">
              <Image
                src="/images/hero/after-balcony.png"
                alt="Chennai apartment balcony after Optima safety net installation"
                fill
                sizes="(max-width: 768px) 100vw, 50vw"
              ...
              <div className="absolute top-4 left-4 bg-success-green text-white text-xs font-bold uppercase px-3 py-1.5 rounded-md shadow-md flex items-center gap-1.5">
                ...
                <span>OPTIMA SAFETY PROTECTED</span>
              </div>
            </div>
            <div className="p-6">
              <h3 className="text-base font-bold text-slate-800 mb-2">After Optima Professional Setup</h3>
              <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
