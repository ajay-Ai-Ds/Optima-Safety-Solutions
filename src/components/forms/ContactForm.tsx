        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 mt-2">
              ...
              >
                <div className="p-3 bg-orange-50 text-accent-orange rounded-xl shrink-0 group-hover:bg-accent-orange group-hover:text-white transition-colors duration-300">
              ...
              <a
                href="mailto:optimasafetysolutions77@gmail.com"
                className="flex items-center gap-4 bg-white p-5 rounded-2xl border border-slate-200 hover:shadow-md transition-shadow group"
              >
            ...
            {status === "success" ? (
              ...
              >
                ...
                <p className="text-slate-500 text-sm max-w-md leading-relaxed">
                  Thank you for reaching out to Optima Safety Solutions. Our team will contact you shortly to schedule your free site measurement and share quotation details.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6" noValidate>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      {...register("name")}
                      className={`w-full bg-slate-50 border px-4 py-3 rounded-xl text-base sm:text-sm focus:outline-hidden focus:ring-2 focus:ring-accent-orange/20 transition-all ${
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      <select
                        ...
                        {...register("service")}
                        className={`w-full bg-slate-50 border px-4 py-3 rounded-xl text-base sm:text-sm focus:outline-hidden focus:ring-2 focus:ring-accent-orange/20 transition-all appearance-none cursor-pointer ${
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    {...register("message")}
                    className="w-full bg-slate-50 border border-slate-200 focus:border-accent-orange px-4 py-3 rounded-xl text-base sm:text-sm focus:outline-hidden focus:ring-2 focus:ring-accent-orange/20 transition-all resize-y"
                  />
                </div>
